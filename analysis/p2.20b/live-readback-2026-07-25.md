...
- kernel: `Linux pve 7.0.14-6-pve #1 SMP PREEMPT_DYNAMIC PMX 7.0.14-6 (2026-07-20T14:45Z) x86_64 GNU/Linux`
- cmdline: `BOOT_IMAGE=/vmlinuz-7.0.14-6-pve root=ZFS=/ROOT/pve-1 ro root=ZFS=rpool/ROOT/pve-1 boot=zfs amd_iommu=on iommu=pt quiet pcie_aspm=force`
...
| AmdSetup | 0x13E | DF Cstates (CBS RN) | 0x01 | 0x01 | 0x00 0x01 0xFF | matches_recommendation |
| AmdSetup | 0x145 | CPPC CTRL (CBS RN) | 0x01 | 0x01 | 0x00 0x01 0x0F | matches_recommendation |
...
| AmdSetup | 0x0F9 | HD Audio Enable (CBS RV) | 0x00 | 0x00 | 0x00 0x01 0x0F | matches_recommendation |
...
| AMD_PBS_SETUP | 0x025 | PM L1 SS | 0x03 (L1.1_L1.2) | 0x03 (L1.1_L1.2) | 0x00 0x01 0x02 0x03 | matches_recommendation |
| AMD_PBS_SETUP | 0x014 | WLAN Enable | 0x00 | 0x00 | 0x00 0x01 | matches_recommendation |
